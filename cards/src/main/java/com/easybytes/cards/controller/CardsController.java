...
public class CardsController {
    ...
    public CardsController(ICardsService iCardsService, @Value("${build.version}") String buildVersion, Environment environment, CardsContactInfoDto cardsContactInfoDto) {
