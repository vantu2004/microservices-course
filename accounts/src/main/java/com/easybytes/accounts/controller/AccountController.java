...
@Tag(
        ...
        description = "CRUD REST APIs in EasyBank to CRUD account details")
@RestController
@Validated
...
public class AccountController {
    ...
    public AccountController(IAccountService iAccountService, @Value("${build.version}") String buildVersion, Environment environment, AccountContactInfoDto accountContactInfoDto) {
    ...
    @Operation(
            ...
            description = "Get build information that í deployed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
